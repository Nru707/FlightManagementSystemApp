...
<%@include file="Base2.jsp" %>
  <div class="container">
        <div class="login-box">
           ...
           <form:form action="${pageContext.request.contextPath}/Admin/deleteroute" method="post" modelAttribute="route">
           <input type="hidden"  name="routeId" value="${routeRecord.routeId}"/>
               <div class="form-group">
                   ...
                   <button type="submit" class="btn btn-primary">DELETE ROUTE</button>
